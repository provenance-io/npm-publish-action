...
The npm-publishing-action repository for the Provenance Blockchain API.
...
1. Either [open](https://github.com/provenance-io/npm-publishing-action/issues/new/choose) or
   [find](https://github.com/provenance-io/npm-publishing-action/issues) an issue you'd like to help with
...
- Looking for a good place to start contributing? How about checking out some
  [good first issues](https://github.com/provenance-io/npm-publishing-action/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
...
- In a main repo (e.g. [provenance](https://github.com/provenance-io/npm-publishing-action)), the preferred branch name format is `<user>/<issue #>-<short description>`.
...
- In a main repo (e.g. [provenance](https://github.com/provenance-io/npm-publishing-action)), the `.x` branch name format is `release/#.#.x`.
...
2. Add a horizontal rule and version section heading, e.g.
   ...
   ## [1.13.0](https://github.com/provenance-io/npm-publishing-action/releases/tag/1.13.0) - 2022-10-04
   ```
...
5. Add a `### Full Commit History` section at the end of the new version section with links to diffs between versions. E.g.
   ...
   * https://github.com/provenance-io/npm-publishing-action/compare/1.12.0...1.13.0
   ```
